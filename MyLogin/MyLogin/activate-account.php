<?php
	...
	{
		$sql = "UPDATE tableaccounts SET status = 'ACTIVE', lastUpdatedBy = ? WHERE username = ? ";
...
<body>
	<div class="center">
        <div class="container">
        	<div class="text">Activate Account</div>
			<form action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method= "POST" role="login">
				<div class="data">
					<label>Are you sure you want to Activate this Account?</label>
