<?php
	...
	{
		$sql = "UPDATE tableequipments SET status = 'RETIRE', lastUpdatedBy = ? WHERE AssetNumber = ? ";
...
<head>
    ...
    <link rel="stylesheet" href="Active.css">
		<title>Retire Equipment</title> 
</head>
<body>
	<div class="center">
        <div class="container">
        	<div class="text">Retire Equipment</div>
			<form action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method= "POST" role="login">
				<div class="data">
					<label>Are you sure you want to Retire this Equipment?</label>
