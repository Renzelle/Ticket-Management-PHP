<?php
	...
	{
		$sql = "UPDATE tableequipments SET status = 'REPAIR', lastUpdatedBy = ? WHERE AssetNumber = ? ";
...
<body>
	<div class="center">
        <div class="container">
        	<div class="text">Repair Equipment</div>
			<form action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method= "POST" role="login">
				<div class="data">
					<label>Are you sure you want to Repair this Equipment?</label>
